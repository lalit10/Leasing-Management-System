...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Waitlist.count') do
      post waitlists_url, params: { waitlist: { applicants: @waitlist.applicants, date_time: @waitlist.date_time, property: @waitlist.property, status: @waitlist.status } }
    end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { applicants: @waitlist.applicants, date_time: @waitlist.date_time, property: @waitlist.property, status: @waitlist.status } }

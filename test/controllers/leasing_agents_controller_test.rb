...
class LeasingAgentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create leasing_agent" do
    assert_difference('LeasingAgent.count') do
      post leasing_agents_url, params: { leasing_agent: { email_address: @leasing_agent.email_address, leasing_id: @leasing_agent.leasing_id, name: @leasing_agent.name, password: @leasing_agent.password, phone_number: @leasing_agent.phone_number } }
    end
  ...
  test "should update leasing_agent" do
    patch leasing_agent_url(@leasing_agent), params: { leasing_agent: { email_address: @leasing_agent.email_address, leasing_id: @leasing_agent.leasing_id, name: @leasing_agent.name, password: @leasing_agent.password, phone_number: @leasing_agent.phone_number } }
